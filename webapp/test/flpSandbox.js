		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comprodeatrainingemployeeapp2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comprodeatrainingemployeeapp2-display": {
								"semanticObject": "comprodeatrainingemployeeapp2",
								"action": "display",
								"description": "A Fiori application to train",
								"title": "App Title",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.prodea.training.employeeapp2",
									"url": sap.ui.require.toUrl("com/prodea/training/employeeapp2")
								}
							}
						}
					}
