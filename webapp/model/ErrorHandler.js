...
], function(UI5Object, MessageBox, MessageManager) {
	"use strict";

	return UI5Object.extend("com.prodea.training.employeeapp2.model.ErrorHandler", {
		...
		constructor: function(oComponent) {
			...
			this._oModel.attachRequestCompleted(function(oEVent, response){
				var oManager = MessageManager;
